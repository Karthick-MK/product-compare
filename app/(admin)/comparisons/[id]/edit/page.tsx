...
export default function EditComparisonPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Two-column on xl+: form left, preview right */}
      <div className={hasGenerated ? 'xl:flex xl:gap-8 xl:items-start' : 'max-w-2xl'}>
        {/* Left: form */}
        <div className={`space-y-6 ${hasGenerated ? 'xl:w-96 xl:flex-shrink-0' : ''}`}>
          {/* Page description */}
        ...
        {/* Right: preview — only when generated */}
        {hasGenerated && (
          <section className="xl:flex-1 space-y-4 pt-2 xl:pt-0 min-w-0">
